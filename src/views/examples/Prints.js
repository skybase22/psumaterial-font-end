...
import ModalQR from '../examples/Modal'
...
class Icons extends React.Component {
  ...
  componentDidMount = () => {
    this.fetchData()
    console.log("slice", this.state.dataToSlice);
  ...
  toggle = () => {
    ...
    console.log("tt", this.state.stateModal);
  ...
  changeDelete = async (id) => {
    ...
    console.log("dataToPrint", this.state.dataToSlice);
  }
                                    ...
                                    >
                                      ...
                                      <div className="icon-shape-delete rounded-circle card-button-add-qr-select"
                                        onClick={async () => {
                                          ...
                                          console.log("dataToPrint", this.state.dataToPrintAfterDelete);
                                        }
                                        }
                                      >
                                    ...
                                    <div className="icon icon-shape rounded-circle shadow card-button-add-qr"
                                      onClick={(() => {
                                        ...
                                        this.state.dataToSlice.push({
                                          id: item.id,
                                          value: `https://psupktmaterial.firebaseapp.com/detail?id=${item.id}`,
                                        ...
                                        console.log("add", this.state.dataToSlice);
                                        this.setState({
